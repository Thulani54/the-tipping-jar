...
export default function OtpVerifyPage() {
  ...
  function verify() {
    ...
    setVerifying(true);
    setError(null);
    // TODO(api): OTP verify endpoint not yet in /api/v2. For now we accept any
    // 6-digit code and continue to the dashboard.
    setTimeout(() => {
      setVerifying(false);
  ...
  function resend() {
    ...
    setResending(true);
    setError(null);
    // TODO(api): OTP resend endpoint not yet in /api/v2.
    setTimeout(() => {
      setResending(false);
      setCooldown(60);
    }, 500);
      ...
      <div className="w-full max-w-md">
        <div className="card">
          ...
          <p className="body-muted mt-2 text-center">
            ...
            <span className="font-semibold text-white">{target}</span>. Enter it below to
            continue.
          </p>
