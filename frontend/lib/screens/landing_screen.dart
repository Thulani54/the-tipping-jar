  ...
  Widget build(BuildContext context) {
    ...
    final brand = Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        ...
        const SizedBox(width: 9),
        Text('TippingJar', style: GoogleFonts.dmSans(
            color: _white, fontWeight: FontWeight.w700, fontSize: 15, letterSpacing: -0.3)),
      ]),
      const SizedBox(height: 14),
      ...
      Container(
        ...
        child: Text('🇿🇦  Proudly South African', style: GoogleFonts.dmSans(
            color: _inkMuted, fontSize: 11.5, fontWeight: FontWeight.w500)),
      ),
    ]);
    ...
    Widget col((String, List<(String, String)>) c) => Column(
      ...
      children: [
        Text(c.$1, style: GoogleFonts.dmSans(
            color: _white, fontWeight: FontWeight.w600, fontSize: 13, letterSpacing: 0.2)),
        const SizedBox(height: 14),
        ...c.$2.map((l) => Padding(
          padding: const EdgeInsets.only(bottom: 10),
          child: GestureDetector(
            onTap: () => context.go(l.$2),
            child: Text(l.$1, style: GoogleFonts.dmSans(color: _inkMuted, fontSize: 13)),
          ),
        )),
      ],
    );
    ...
    return Container(
      color: _darkBg,
      padding: EdgeInsets.fromLTRB(mobile ? 24 : 60, 56, mobile ? 24 : 60, 40),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Container(height: 1, color: _darkBorder, margin: const EdgeInsets.only(bottom: 48)),
        if (mobile) ...[
          brand, const SizedBox(height: 36),
        ...
        Container(height: 1, color: _darkBorder),
        const SizedBox(height: 20),
        Text('© 2026 TippingJar (Pty) Ltd. All rights reserved.',
            style: GoogleFonts.dmSans(color: _inkMuted.withOpacity(0.7), fontSize: 12)),
      ]),
    );
  }
}
